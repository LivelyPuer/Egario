...
public class EgarioForm {
    ...
    public EgarioForm(Animation animation, boolean isSuper, boolean isFire){
    ...
    public EgarioForm onTouchEnemy(ImageLoader imageLoader) {
        ...
        return new EgarioForm(newAnimation, false, false);
    }
